...
//   if (totalScore <= 20) return 'Low Emotional Awareness. You might want to focus more on understanding and expressing your emotions. Consider practicing mindfulness or seeking support to better connect with your feelings.';
//   if (totalScore <= 40) return 'Moderate Emotional Awareness. You have some practices in place, but there is room for growth. Engaging in more self-reflection and emotional exercises could enhance your emotional connection.';
//   if (totalScore <= 60) return 'High Emotional Awareness. You have a good understanding and connection with your emotions. Continue nurturing this aspect and consider deepening your emotional practices for even greater balance.';
//   return 'Very High Emotional Awareness. You have a strong grasp of your emotions and consistently practice emotional self-care. Keep up the great work and continue to foster your emotional well-being.';
// };
...
//             <h2>Your Emotional Awareness Level:</h2>
//             <p>{result}</p>
//           </div>
//         )}
//       </form>
