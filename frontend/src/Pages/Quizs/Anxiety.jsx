...
//   if (totalScore <= 20) return 'Low Anxiety. You generally feel calm and have good control over your worries. Continue maintaining your healthy coping mechanisms and consider focusing on activities that enhance your well-being.';
//   if (totalScore <= 40) return 'Moderate Anxiety. You might experience anxiety occasionally, but it’s manageable. Reflect on ways to reduce stress and engage in relaxation techniques to better handle anxious feelings.';
//   if (totalScore <= 60) return 'High Anxiety. You experience significant anxiety and might struggle with various aspects of daily life. It could be helpful to seek support from a professional and explore strategies to manage your anxiety more effectively.';
//   return 'Severe Anxiety. Your level of anxiety appears to be intense and could be impacting your life significantly. Seeking help from a mental health professional is highly recommended to receive appropriate support and treatment.';
// };
...
//             <h2>Your Anxiety Level: {result}</h2>
//             </div>
//         )}
//         </div>
//     );
