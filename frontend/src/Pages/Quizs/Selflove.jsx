...
//   if (totalScore <= 20) return 'Low Self-Love. You may be struggling to accept and care for yourself. It’s important to remember that self-love is a journey, and it’s okay to take small steps towards nurturing yourself.';
//   if (totalScore <= 40) return 'Moderate Self-Love. You have some self-love practices in place, but there is room to grow. Consider focusing on areas where you can further support and uplift yourself.';
//   if (totalScore <= 60) return 'High Self-Love. You generally show yourself kindness and care, but there are still areas to improve. Keep building on your self-love habits and continue to prioritize your well-being.';
//   return 'Very High Self-Love. You have a strong sense of self-love and practice it regularly. This is a great foundation for a healthy and fulfilling life. Keep up the wonderful work of taking care of yourself!';
// };
