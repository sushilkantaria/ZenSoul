...
//     const ishome=location.pathname==='/Home' || location.pathname==='/' || location.pathname === '/AnxietyPg'  || location.pathname === '/StressedPg'  || location.pathname === '/FrustratedPg'  || location.pathname === '/MoodSwingsPg'  || location.pathname === '/BoredomPg' || location.pathname === '/Meditation' || location.pathname === '/Sounds';
...
//             const userToken = localStorage.getItem('token'); // Check for the token as stored in Login
//             setIsLoggedIn(!!userToken); // Set isLoggedIn to true if token exists
//         };

//         checkLoginStatus(); // Check login status when component mounts

//         // Set up an event listener to detect changes in localStorage (e.g., on logout)
